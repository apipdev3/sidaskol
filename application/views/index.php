...
<head>
    <meta charset="utf-8">
    <title>Sekolah Menengah Sample</title>
    <!-- Meta -->
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="<?= base_url();?>files/landingpage/assets\logos\favicon.ico" type="image/png" sizes="16x16">
    <!-- Bootstrap -->
    <link href="<?= base_url();?>files/landingpage/assets\css\bootstrap.min.css" rel="stylesheet" type="text/css" media="all">
    <!-- Font -->
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,700" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Poppins:400,300,500,700,600" rel="stylesheet" type="text/css">
    <!-- Animate CSS -->
    <link rel="stylesheet" href="<?= base_url();?>files/landingpage/assets\css\animate.css">
    <!-- Owl Carousel -->
    <link rel="stylesheet" href="<?= base_url();?>files/landingpage/assets\css\owl.carousel.css">
    <link rel="stylesheet" href="<?= base_url();?>files/landingpage/assets\css\owl.theme.css">
    <!-- Magnific Popup -->
    <link rel="stylesheet" href="<?= base_url();?>files/landingpage/assets\css\magnific-popup.css">
    <!-- Full Page Animation -->
    <link rel="stylesheet" href="<?= base_url();?>files/landingpage/assets\css\animsition.min.css">
    <!-- Ionic Icons -->
    <link rel="stylesheet" href="<?= base_url();?>files/landingpage/assets\css\ionicons.min.css">
    <!-- Main Style css -->
    <link href="<?= base_url();?>files/landingpage/assets\css\style.css" rel="stylesheet" type="text/css" media="all">

    <style>
        .navbar-kemenag{
            background: rgb(28,150,201);
            background: linear-gradient(90deg, rgba(28,150,201,1) 1%, rgba(28,110,2,1) 74%);
        }
    </style>
</head>
...
<body>
    ...
    <div class="wrapper animsition" data-animsition-in-class="fade-in" data-animsition-in-duration="1000" data-animsition-out-class="fade-out" data-animsition-out-duration="1000">
        <div class="container">
             <nav class="navbar navbar-expand-lg navbar-light navbar-default navbar-fixed-top" role="navigation">
                <div class="container">
                    <a class="navbar-brand page-scroll" href="#main"><img src="<?= base_url();?>files/landingpage/assets\logos\logo.png" alt="adminity Logo"></a>
        ...
        <div class="main" id="main">
                        ...
                        <div class="row justify-content-md-center ">
                            ...
                            <div class="col-md-12">
                                <div class="hero-image">
                                    <img class="img-fluid" src="<?= base_url();?>files/landingpage/assets\images\app_hero_1.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.2s">
                                        <div class="services-icon">
                                            <img src="<?= base_url();?>files/landingpage/assets\logos\icon1.png" height="60" width="60" alt="Service">
                                        </div>
                                    ...
                                    <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.3s">
                                        <div class="services-icon">
                                            <img class="icon-2" src="<?= base_url();?>files/landingpage/assets\logos\icon2.png" height="60" width="60" alt="Service">
                                        </div>
                                        <div class="services-description">
                                    ...
                                    <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.4s">
                                        <div class="services-icon">
                                            <img class="icon-3" src="<?= base_url();?>files/landingpage/assets\logos\icon3.png" height="60" width="60" alt="Service">
                                        </div>
                                        <div class="services-description">
                    ...
                    <div class="flex-split">
                        <div class="f-left wow fadeInUp" data-wow-delay="0s">
                            <div class="left-content">
                                <img class="img-fluid" src="<?= base_url();?>files/landingpage/assets\images\feature_1.png" alt="">
                            </div>
                        </div>
                    ...
                    <div class="flex-split">
                        ...
                        <div class="f-left">
                            <div class="left-content wow fadeInUp" data-wow-delay="0.3s">
                                <img class="img-fluid" src="<?= base_url();?>files/landingpage/assets\images\feature_2.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row text-center">
                        <div class="col-md-12">
                            <div class="testimonials owl-carousel owl-theme">
                                <div class="testimonial-single"><img class="img-circle" src="<?= base_url();?>files/landingpage/assets\images\testimonial2.jpg" alt="Client Testimonoal">
                                ...
                                <div class="testimonial-single"><img class="img-circle" src="<?= base_url();?>files/landingpage/assets\images\testimonial1.jpg" alt="Client Testimonoal">
                                ...
                                <div class="testimonial-single"><img class="img-circle" src="<?= base_url();?>files/landingpage/assets\images\testimonial3.jpg" alt="Client Testimonoal">
                                    <div class="testimonial-text">
            ...
            <div class="feature_huge text-center">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <img class="img-fluid wow fadeInUp" data-wow-delay="0.1s" src="<?= base_url();?>files/landingpage/assets\images\big_feature.png" alt="" style="max-width:100%">
                        </div>
                        <div class="col-md-12 feature_list">
                            <div class="row">
                                <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.2s">
                                    <img src="<?= base_url();?>files/landingpage/assets\logos\feature_icon.png" alt="Feature">
                                ...
                                <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.4s">
                                    <img src="<?= base_url();?>files/landingpage/assets\logos\feature_icon_2.png" alt="Feature">
                                ...
                                <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.6s">
                                    <img src="<?= base_url();?>files/landingpage/assets\logos\feature_icon_3.png" alt="Feature">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="table-left wow fadeInUp" data-wow-delay="0.4s">
                                        <div class="icon">
                                            <img src="<?= base_url();?>files/landingpage/assets\logos\cart2.png" alt="Icon">
                                        </div>
                                ...
                                <div class="col-sm-6 ">
                                    <div class="table-right wow fadeInUp" data-wow-delay="0.6s">
                                        <div class="icon">
                                            <img src="<?= base_url();?>files/landingpage/assets\logos\cart1.png" alt="Icon">
                                        </div>
                                        <div class="pricing-details">
                                            <h2>Premium Plan</h2>
                                            <span>$19.99</span>
            ...
            <div class="client-section">
                <div class="container text-center">
                    <div class="clients owl-carousel owl-theme">
                        <div class="single">
                            <img src="<?= base_url();?>files/landingpage/assets\logos\logo1.png" alt="">
                        </div>
                        <div class="single">
                            <img src="<?= base_url();?>files/landingpage/assets\logos\logo2.png" alt="">
                        </div>
                        <div class="single">
                            <img src="<?= base_url();?>files/landingpage/assets\logos\logo3.png" alt="">
                        </div>
                        <div class="single">
                            <img src="<?= base_url();?>files/landingpage/assets\logos\logo4.png" alt="">
                        </div>
                        <div class="single">
                            <img src="<?= base_url();?>files/landingpage/assets\logos\logo6.png" alt="">
                        </div>
                        <div class="single">
                            <img src="<?= base_url();?>files/landingpage/assets\logos\logo7.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="footer">
                <div class="container">
                    <div class="col-md-12 text-center">
                        <img src="<?= base_url();?>files/landingpage/assets\logos\logo.png" alt="Adminty Logo">
    ...
    <script type="text/javascript" src="<?= base_url();?>files/landingpage/assets\js\jquery-2.1.1.js"></script>
    <script type="text/javascript" src="<?= base_url();?>files/landingpage/assets\js\bootstrap.min.js"></script>
    <script type="text/javascript" src="<?= base_url();?>files/landingpage/assets\js\plugins.js"></script>
    <script type="text/javascript" src="<?= base_url();?>files/landingpage/assets\js\menu.js"></script>
    <script type="text/javascript" src="<?= base_url();?>files/landingpage/assets\js\custom.js"></script>
</body>
